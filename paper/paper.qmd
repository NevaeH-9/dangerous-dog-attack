...
The dataset '"About registry of Dogs Subject to and Issued a Dangerous Dog Order" '[@toronto2023]has been used in this paper to analyze what breed of dogs are tend to be more aggressive and what breed of dogs is making worse attack circumstances. 'Programming language R'[@citeR] is been used in this paper to clean and analyze the dataset. Packages that could installed in R: 'tidyverse'[@tidyverse], 'ggplot2'[@ggplot], 'dplyr'[@dplyr], 'here'[@here] and ‘opendatatoronto'[@opendatatoronto]are used to download the dataset to R and making test to the dataset.
